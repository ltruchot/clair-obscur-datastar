class f extends HTMLElement {
  ...
  attachEventListeners() {
    const t = this.querySelector('#font-picker-button'),
      e = this.querySelector('#font-picker-popover'),
    ...
    (t.addEventListener('click', () => {
      ...
      e.addEventListener('toggle', (l) => {
        l.newState === 'open' &&
          requestAnimationFrame(() => {
            ...
            let i = o.bottom + n,
              r = o.left;
            (r + c.width > a && (r = a - c.width - n),
              i + c.height > p && (i = p - c.height - n),
              r < 0 && (r = n),
              i < 0 && (i = n),
      ...
      d.forEach((l) => {
        l.addEventListener('click', (s) => {
          ...
          o &&
            (this.dispatchEvent(new CustomEvent('fontchange', { detail: { value: o }, composed: !0 })),
            e.hidePopover());
        });
      }));
  }
...
u();
export { f as FontPickerElement, u as registerFontPickerElement };
