...
<span data-effect="$_ignition ? document.getElementsByClassName('toto')[0].classList.add('animated') : document.getElementsByClassName('toto')[0].classList.remove('animated')"></span>
...
<img class="rocket" data-class:animated="$_ignition" src="./assets/rocket.png" alt="Rocket" />
